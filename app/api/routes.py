...
listing_parser.add_argument('price', type=float, required=True, help='Price is required')
listing_parser.add_argument('category', type=str, required=True, help='Category is required')
