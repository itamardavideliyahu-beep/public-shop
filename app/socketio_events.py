...
def handle_connect():
    ...
    if current_user.is_authenticated:
        emit('connected', {'user_id': current_user.id, 'message': 'Connected to real-time chat'})
    else:
...
def handle_join_conversation(data):
    ...
    if conversation and current_user.id in (conversation.buyer_id, conversation.seller_id):
